...
- **hook のガードの前提が変わる。** スクリプトの解決先と状態ファイルの置き場が worktree で割れる。
  [worktree に入るとガード hook の前提が変わる](../hooks/hook-guards-under-worktree-isolation.md)
...
- [worktree に入るとガード hook の前提が変わる](../hooks/hook-guards-under-worktree-isolation.md) — このパターンの副作用
