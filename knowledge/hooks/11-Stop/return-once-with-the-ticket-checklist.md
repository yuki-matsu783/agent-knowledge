...
# 完了時にやらせたい作業はチケットに置き Stop hook で 1 回だけ機械的に差し戻すべき
...
4 つのフィールドと 8 回の上限は 2026-09-05 時点の公式 hooks ドキュメントにも載っており、上の表は同梱実体の読み取りと突き合わせたもの。実際に hook を登録して走らせたわけではない。
