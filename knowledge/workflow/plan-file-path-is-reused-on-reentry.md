...
# Plan モードへ再突入したら同じ plan ファイルパスが提示され続けた
...
- [タスクの切れ目で /compact と /clear をユーザに依頼させる](../hooks/22-PostToolUse/ask-user-to-reset-context-at-task-boundaries.md)。セッションを切る運用と、issue 単位の計画判定の組み合わせ
