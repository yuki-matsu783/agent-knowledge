...
- **claude-code**: [inbox/archify-verified-architecture-diagrams](inbox/archify-verified-architecture-diagrams.md), [knowledge/archify-diagrams-from-templates](knowledge/archify-diagrams-from-templates.md)
